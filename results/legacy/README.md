...
|---|---|---|
| `pmc_audiocaps_r1_single_seed42.csv` | Early AudioCaps R@1 re-eval under a since-renamed output convention (`_single` suffix) | `pmc_audiocaps_r1_seed42.csv` naming in `scripts/reproduce_audiocaps.py` (regenerable) |
