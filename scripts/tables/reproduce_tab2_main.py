...
it reads results/sources/nprobe_sweep_pivot.csv (nlist_setting == "sqrtN") at an
...
Outputs:
  ...
  - results/tables/tab2_main_reproduced.csv
"""
...
OUTPUT_CSV = RESULTS_DIR / "tables" / "tab2_main_reproduced.csv"
