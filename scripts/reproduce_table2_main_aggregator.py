...
MS_SOURCE_FILES = [
    ...
    RESULTS_DIR / "pmc_laion400m_nlist80k_seed42.csv",            # LAION forward
    RESULTS_DIR / "pmc_laion400m_reverse_nlist80k_seed42.csv",    # LAION reverse (db-side)
]
...
def compute_table_rows(
    ...
    laion = source_data["pmc_laion400m_nlist80k_seed42.csv"]
    ...
    laion_ms = ms_data.get("pmc_laion400m_nlist80k_seed42.csv", [])
    ...
    if laion_reverse_path.exists():
        ...
        laion_reverse_ms = ms_data.get("pmc_laion400m_reverse_nlist80k_seed42.csv", [])
