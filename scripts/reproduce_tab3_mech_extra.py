"""Reproduce Table 3 (tab:mech_extra): component ablation and IVF-RaBitQ controls.
...
Table 3. Its logic now lives in scripts/analysis/verify_calibration.py, which
...
Outputs:
  ...
  - results/tab3_mech_extra_reproduced.csv
"""
...
OUTPUT_CSV = RESULTS_DIR / "tab3_mech_extra_reproduced.csv"
...
def print_latex_rows(ablation: list[dict[str, str]],
                     ivf_controls: list[dict[str, str]]) -> None:
    print("\n% --- auto-generated by reproduce_tab3_mech_extra.py ---")
    print("% Table 3 (tab:mech_extra)")
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Reproduce Table 3 (tab:mech_extra): component ablation and IVF controls"
    )
    parser.parse_args()
