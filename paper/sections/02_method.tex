...
Multi-bit quantization (IVFPQ~\cite{jegou2011pq}, OPQ~\cite{ge2013opq}) partially absorbs displacement through wider error margins; BQ is maximally vulnerable and is the focus of our main claims (multi-bit: Section~\ref{sec:multibit}). PMC applies to all $\mathrm{sign}(\cdot{-}c)$ methods and analogous schemes such as LSH~\cite{wang2018hashsurvey}.\looseness=-1
